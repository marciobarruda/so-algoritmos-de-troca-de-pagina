...
public class Main
{
	...
	public static void main(String[] args)
	{
		...
		// Tamanhos de FrameBuffer pedidos no trabalho:
		int tamanhos_de_FrameBuffer[] = {1,10,50,100,500,750,900,1000};
		int valores_de_PageFaults[] = new int[tamanhos_de_FrameBuffer.length];
		...
		{
			optimal = new FIFO(tamanhos_de_FrameBuffer[i], referenceString);
			optimal.executar();
			valores_de_PageFaults[i] = optimal.getPageFaultCount();
		}
		for (int i=0 ; i<tamanhos_de_FrameBuffer.length ; i++)
		...
		for (int i=0 ; i<tamanhos_de_FrameBuffer.length ; i++)
		{
			fifo = new FIFO(tamanhos_de_FrameBuffer[i], referenceString);
			fifo.executar();
			valores_de_PageFaults[i] = fifo.getPageFaultCount();
		}
		for (int i=0 ; i<tamanhos_de_FrameBuffer.length ; i++)
			System.out.print(tamanhos_de_FrameBuffer[i]+"\t");
		System.out.println();
		...
		for (int i=0 ; i<tamanhos_de_FrameBuffer.length ; i++)
		{
			lru = new FIFO(tamanhos_de_FrameBuffer[i], referenceString);
			lru.executar();
			valores_de_PageFaults[i] = lru.getPageFaultCount();
		}
		for (int i=0 ; i<tamanhos_de_FrameBuffer.length ; i++)
			System.out.print(tamanhos_de_FrameBuffer[i]+"\t");
		System.out.println();
		...
		for (int i=0 ; i<tamanhos_de_FrameBuffer.length ; i++)
		{
			mfu = new FIFO(tamanhos_de_FrameBuffer[i], referenceString);
			mfu.executar();
			valores_de_PageFaults[i] = mfu.getPageFaultCount();
		}
		for (int i=0 ; i<tamanhos_de_FrameBuffer.length ; i++)
			System.out.print(tamanhos_de_FrameBuffer[i]+"\t");
		System.out.println();
		...
		for (int i=0 ; i<tamanhos_de_FrameBuffer.length ; i++)
		{
			lfu = new FIFO(tamanhos_de_FrameBuffer[i], referenceString);
			lfu.executar();
			valores_de_PageFaults[i] = lfu.getPageFaultCount();
		}
		for (int i=0 ; i<tamanhos_de_FrameBuffer.length ; i++)
			System.out.print(tamanhos_de_FrameBuffer[i]+"\t");
		System.out.println();
